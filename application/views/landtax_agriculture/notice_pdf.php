...
<html>
    ...
    <body>
        ...
        <div class="f-s-14px f-aum"><?php echo $notice_data['occupant_name']; ?></div>
        ...
        <table class="t-a-c table">
            <tr>
                ...
                <td class="f-w-b">Khata Number</td>
            ...
            <tr>
                ...
                <td class="f-aum v-a-m" style="width: 100px;"><?php echo $notice_data['khata_number']; ?></td>
                <td class="t-a-r" style="width: 130px;"><?php echo $notice_data['notice_amount']; ?>/-</td>
                <td style="width: 130px;"><?php echo convert_to_new_date_format($notice_data['notice_date']); ?></td>
            </tr>
            <tr>
                <td colspan="3" class="f-w-b t-a-r" style="margin-left: 10px;">Grand Total :</td>

...
<div class="card-body p-b-0px text-left" style="font-size: 13px;">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-padding">
            ...
            <tbody id="fld_container_for_ftview"></tbody>
            <tfoot>
                <tr>
                    <td class="f-w-b text-right text-success v-a-m bg-beige" colspan="6">Rupees To Be Paid : </td>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Copies : <span id="total_copies_for_ftview"></span></th>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Pages : <span id="total_pages_for_ftview"></span></th>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Rs. : <span id="total_amount_for_ftview"></span>/-</th>
                </tr>
            </tfoot>
        </table>
    </div>
            ...
            <tr>
                ...
                <td style="width: 180px; border-top: none;">
                    <img style="border: 2px solid blue; width: 160px; height: 180px;"
                         src="{{FORM_THREE_DOC_PATH}}{{applicant_photo}}">
                </td>
                {{/if}}
                <td style="border-top: none; vertical-align: top !important;">
                    <div>
                        {{#if show_id_proof}}
                        <a target="_blank" href="{{FORM_THREE_DOC_PATH}}{{id_proof}}">
                        ...
                        <a target="_blank" href="{{FORM_THREE_DOC_PATH}}{{other_document}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
...
<div class="card-footer text-right">
    {{#if show_print_btn}}
    <button type="button" class="btn btn-sm btn-danger" onclick="window.print();" id="pa_btn_for_ftview">

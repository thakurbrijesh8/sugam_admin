<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table id="notice_history_datatable" class="table table-bordered table-padding table-hover vat-top">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center v-a-m" style="min-width: 350px;">Survey / Subdiv Details</th>

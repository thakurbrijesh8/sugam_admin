<div class="card-header">
    <h3 class="card-title f-w-b" style="float: none; text-align: center;">
        View Generated Property Card Nakal Details 
    </h3>
</div>
<div class="card-body p-b-0px text-left" style="font-size: 13px;">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-sm btn-info" 
                            onclick="PropertyCard.listview.requestForReGenerateFormDB($(this),'{{form_land_details_id}}', VALUE_ONE);">
                        <i class="fas fa-recycle"></i> &nbsp; Re-Generate Form-D Copy</button>
                    {{/if}}
                    {{#if show_regenerate_fb_details}}
                    <button type="button" class="btn btn-sm btn-info" 
                            onclick="PropertyCard.listview.requestForReGenerateFormDB($(this),'{{form_land_details_id}}', VALUE_TWO);">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-padding">
            ...
            <tbody id="cd_container_for_pccd"></tbody>
        </table>
    </div>
</div>
...
<html>
    ...
    <body>
        ...
        $pre_city_text = $pre_city;
        $per_city_text = $per_city;
        ...
        <div style="font-family: arial_unicode_ms;">
            ...
            <div class="l-s l-h" style="height: 90px; margin-top: 20px;">
                ...
                રહેવાસી <span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $pre_house_no . ',&nbsp;' . ($pre_house_name == '' ? '' : $pre_house_name . ',&nbsp;') . $pre_street . ',&nbsp;' . $pre_village . ',&nbsp;' . $pre_city_text . ',&nbsp;' . $pre_pincode . '&nbsp;&nbsp;&nbsp;'; ?></span>નાં આજ રોજ તલાટી – <?php echo $taluka_name_guj; ?> અને <?php echo $village_name_text_seja . ' સેજા'; ?> રૂબરૂ હાજર થઇ પુછવાથી 
                લખાવું છું કે મહે. મામલતદાર સાહેબ <?php echo $taluka_name_guj; ?> ની ઓફીસમાં મરનારના કુટુબના સભ્યો તરીકેનું સર્ટીફીકેટ મેળવવા જે અરજી કરેલ છે. તે મારી પોતાની છે.
            </div>
            <div class="l-s l-h" style="height: 20px;margin-left: 50px;">સ્વર્ગસ્થ :-<span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $death_person_name . '&nbsp;&nbsp;&nbsp;'; ?></span> જે મારા <span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $relation_with_applicant_text . '&nbsp;&nbsp;&nbsp;'; ?></span> . જેમનું અવસાન મરણ  </div>
            ...
            <?php $efm_cnt = 1; ?>
            <table class="monthly-income l-s" style="font-size: 13px; margin-top: 5px;font-family: arial_unicode_ms;">
                <tr>
                    ...
                    <td class="f-w-b t-a-c" style="width: 150px; font-size: 12px;">સંબંધ</td>
        ...
        <div style="font-family: arial_unicode_ms;">
            ...
            <div class="l-s" style="margin-top: 10px;">
                નાં તે આજરોજ તલાટી- <?php echo $taluka_name_guj; ?> અને <?php echo $village_name_text_seja; ?> રૂબરૂ હાજર થઇ પુછવાથી લખાવીએ છીએ કે મહે. મામલતદાર સાહેબ <?php echo $taluka_name_guj; ?> ની 
            </div>
            ...
            <div class="l-s l-h" style="height: 20px;margin-left: 50px;">સ્વર્ગસ્થ :-<span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $death_person_name . '&nbsp;&nbsp;&nbsp;'; ?></span> જે તેઓનાં  <span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $relation_with_applicant_text . '&nbsp;&nbsp;&nbsp;'; ?></span> . હતા. જેમનું અવસાન મરણ   </div>
        ...
        <div style="font-family: arial_unicode_ms;">
            ...
            <div class="l-s l-h" style="height: 90px;">
                ...
                રહેવાસી <span class="b-b-1px f-w-b"><?php echo '&nbsp;&nbsp;&nbsp;' . $pre_house_no . ',' . ($pre_house_name == '' ? '' : $pre_house_name . ',')  . $pre_street . ',' . $pre_village . ',' . $pre_city_text . ',' . $pre_pincode . '&nbsp;&nbsp;&nbsp;'; ?></span> નાંએ મરનાર ના સભ્યો તરીકેનું સર્ટીફીકેટ મેળવવા અરજી કરેલ છે તે બાબતે. 
            </div>
        ...
        <div style="font-size: 13px;">
            ...
            <table class="app-form-income" style="font-size: 13px; margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td><?php echo $pre_house_no . ',' . ($pre_house_name == '' ? '' : $pre_house_name . ',') . $pre_street . ',' . $pre_village . ',' . $pre_city_text . ',' . $pre_pincode; ?></td>
                </tr>
                <tr>
                    <td class="f-w-b">Permanent Address</td>
                    <td><?php echo $per_house_no . ',' . ($per_house_name == '' ? '' : $per_house_name . ',') . $per_street . ',' . $per_village . ',' . $per_city_text . ',' . $per_pincode; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo $relation_with_applicant_text . ' / ' . $death_person_name; ?></td>
                </tr>
                <tr>
                    <td class="f-w-b">Relation with Applicant / Death Date / Death of Place</td>
                    <td><?php echo $relation_deceased_person_text . ' / ' . convert_to_new_date_format($death_date) . ' / ' . $death_place; ?></td>
                </tr>
                <tr>
        ...
        <td style="vertical-align: top; text-align: right;" class="f-w-b"><?php echo indian_comma_income($total_income) . '/-'; ?></td>
            ...
            <div style="font-size: 13px;">
                ...
                <div class="l-s" style="margin-top: 5px; text-align: justify; text-justify: inter-word; line-height: 25px;">
                    ...
                    Resident of <span class="b-b-1px f-w-b">&nbsp;&nbsp;&nbsp;<?php echo $pre_house_no . ',&nbsp;' . ($pre_house_name == '' ? '' : $pre_house_name . ',&nbsp;') . $pre_street . ',&nbsp;' . $pre_village . ',&nbsp;' . $pre_city_text . ',&nbsp;' . $pre_pincode; ?> &nbsp;&nbsp;&nbsp;</span>,
                ...
                <div class="l-s l-h" style="text-align: justify; text-justify: inter-word; margin-top: 5px;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    1. That my <span class="b-b-1px f-w-b">&nbsp;&nbsp;&nbsp;<?php echo $relation_with_applicant_text; ?>&nbsp;(<?php echo $death_person_name; ?>)&nbsp;&nbsp;&nbsp;</span> was expired on <span class="b-b-1px f-w-b">&nbsp;&nbsp;&nbsp;<?php echo convert_to_new_date_format($death_date); ?>&nbsp;&nbsp;&nbsp;</span>
                ...
                <div class="l-s l-h" style="margin-top: 5px;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    2. That after the death of my <span class="b-b-1px f-w-b">&nbsp;&nbsp;&nbsp;<?php echo $relation_with_applicant_text; ?>&nbsp;(<?php echo $death_person_name; ?>)&nbsp;&nbsp;&nbsp;</span>, I/We

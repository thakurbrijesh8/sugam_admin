<tr>
    ...
    <!--    {{#if enable_pgcp_sror}}
        <td class="text-center f-w-b f-s-16px cursor-pointer"
            onclick="Dashboard.listview.changeRouterForMam({{module_type}},{{district}},{{VALUE_TWO}},{{VALUE_ONE}});">
            <span class="badge bg-warning app-status f-s-18px mw-label">{{fees_paid}}</span></td>
        <td class="text-center f-w-b f-s-16px cursor-pointer"
            onclick="Dashboard.listview.changeRouterForMam({{module_type}},{{district}},{{VALUE_TWO}},{{VALUE_TWO}});">
            <span class="badge bg-info app-status f-s-18px mw-label">{{fees_paid_generated}}</span></td>
        <td class="text-center f-w-b f-s-16px cursor-pointer"
            onclick="Dashboard.listview.changeRouterForMam({{module_type}},{{district}},{{VALUE_TWO}},{{VALUE_THREE}});">
            <span class="badge bg-orange app-status f-s-18px mw-label">{{fees_paid_prepared}}</span></td>
        <td class="text-center f-w-b f-s-16px cursor-pointer"
            onclick="Dashboard.listview.changeRouterForMam({{module_type}},{{district}},{{VALUE_TWO}},{{VALUE_FOUR}});">

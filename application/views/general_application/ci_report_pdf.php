<html>
    ...
    <body>
        <div class="">
            ...
            <hr>
            <div class="f-s-14px f-aum">सं. / No. CI/DMN/EST/<?php echo $report_data['application_year']; ?>/	
...
<!--                    <td style="width: 38%;">
                    ...
                    <td class="t-a-c" style="vertical-align: bottom; width: 24%;text-align: right;">
                        ...
                        <div class="t-a-c footer-title" style="text-align: justify;"><b>Circle Inspector,</b></div>

                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label class="applicant_name_for_nc_div">2. Name of Applicant <span class="color-nic-red">*</span></label>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" id="mobile_number_for_nc" name="mobile_number" class="form-control" placeholder="Enter Mobile Number !"
                                           maxlength="10" onkeyup="checkNumeric($(this));"
                                           onblur="checkValidationForMobileNumber('ncl-certificate', 'mobile_number_for_nc');" value="{{ncl_certificate_data.mobile_number}}">
                                    <span class="error-message error-message-ncl-certificate-mobile_number_for_nc"></span>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label>6. Applicant's Email Address </label>
                                    <input type="text" id="email_for_nc" name="email"
                                           class="form-control" placeholder="Enter Email !"  maxlength="50"
                                           onblur="checkValidationForEmail('ncl-certificate', 'email_for_nc');" value="{{ncl_certificate_data.email}}">
                                    <span class="error-message error-message-ncl-certificate-email_for_nc"></span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="aadhaar_for_nc" name="aadhaar"
                                               class="form-control" onkeyup="checkNumeric($(this));" placeholder="Enter Aadhaar Number !"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="election_no_for_nc" name="election_no"
                                               class="form-control" placeholder="Enter Election Number !"
                                               maxlength="12" value="{{ncl_certificate_data.election_no}}">
                                    </div>
                                    <span class="error-message error-message-ncl-certificate-election_no_for_nc"></span>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="applicant_nationality_for_nc" name="applicant_nationality" class="form-control" placeholder="Enter Applicant Nationality!"
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="applicant_education_for_nc" name="applicant_education" class="form-control" placeholder="Enter Applicant Education!"
                                           maxlength="50" onblur="checkValidation('ncl-certificate', 'applicant_education_for_nc', applicantEducationValidationMessage);" value="{{ncl_certificate_data.applicant_education}}">
                                ...
                                <div class="form-group col-sm-4 col-md-4">
                                    ...
                                    <input type="text" id="name_of_school_for_nc" name="name_of_school"
                                           maxlength="50" class="form-control" value="{{ncl_certificate_data.name_of_school}}" placeholder="Enter Name of School / Collage / Institute !" onblur="checkValidation('ncl-certificate', 'name_of_school_for_nc', schoolNameValidationMessage);"
                                           >
                                    <span class="error-message error-message-ncl-certificate-name_of_school_for_nc"></span>
                                </div>
                            </div> 
                            ...
                            <div class="row marital_status_div_for_nc">
                                <div class="form-group col-sm-6">
                                    <label>15. Marital Status<span class="color-nic-red">*</span></label>
                                    <div id="marital_status_container_for_nc"></div>
                                    <span class="error-message error-message-ncl-certificate-marital_status_for_nc"></span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <label>16.Select Cast. <span class="color-nic-red">*</span></label>
                                    <select id="obccaste_for_nc" name="obccaste" class="form-control select2" onchange="checkValidation('ncl-certificate', 'obccaste_for_nc', religionValidationMessage);" data-placeholder="Select Caste" style="width: 100%;">
                                    </select>
                                    <span class="error-message error-message-ncl-certificate-obccaste_for_nc"></span>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>17. Select Applicant Religion.<span class="color-nic-red">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-sm-4" id="other_religion_for_ncl_certificate" style="display: none;">
                                    <label>17.1 Applicant Other Religion.<span class="color-nic-red">*</span></label>
                                    <div class="input-group">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <select id="occupation_for_nc" name="occupation" class="form-control select2" onchange="checkValidation('ncl-certificate', 'occupation_for_nc', applicantOccupationValidationMessage); showOtherapplicantOccupationtext(this, 'applicant_occupation_other_div', 'ncl_certificate');" data-placeholder="Select Occupation" style="width: 100%;">
                                    </select>
                                    <span class="error-message error-message-ncl-certificate-occupation_for_nc"></span>
                                </div>
                                <div class="form-group col-sm-3" id="applicant_occupation_other_div_for_ncl_certificate" style="display: none;">

                                    <label>19.1 Other Occupation Detail</label>
                                    <input type="text" id="other_occupation_for_nc" name="other_occupation"
                                           maxlength="50" class="form-control" value="{{ncl_certificate_data.other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('ncl-certificate', 'other_occupation_for_nc', otherOccupationValidationMessage);"
                                           >
                                    <span class="error-message error-message-ncl-certificate-other_occupation_for_nc"></span>
                                    <!-- </div> -->
                                </div>
                                <div class="form-group col-sm-3">
                                    <label>20.  Applicant Annual Income <span class="color-nic-red">*</span></label>
                                    <input type="text" id="annual_income_for_nc" name="annual_income" class="form-control" placeholder="Enter Applicant Annual Income!"
                                           maxlength="10" onkeyup="checkNumeric($(this))" onblur="checkValidation('ncl-certificate', 'annual_income_for_nc', annualIncomeValidationMessage);" value="{{ncl_certificate_data.annual_income}}">
                                    <span class="error-message error-message-ncl-certificate-annual_income_for_nc"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card" style="background-color: #F8F8F8;">
                        ...
                        <div class="card-body border-nic-blue ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-4 col-md-3">
                                            ...
                                            <input type="text" id="father_other_occupation_text_for_nc" name="father_other_occupation_text_for_nc"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.father_other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('ncl-certificate', 'father_other_occupation_text_for_nc', otherOccupationValidationMessage);"
                                                   style="display: none;">
                            ...
                            <div class="card spouse_info_item_container_for_nc" style="background-color: #F8F8F8; display: none;">
                                <div class="card-header pt-1 pb-1 bg-nic-blue">
                                    <div class="row">
                                        <div class="col-12 f-w-b">
                                            20.(c) Spouse Details 
                                ...
                                <div class="card-body border-nic-blue ">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6 col-md-4">
                                            <label>1. Spouse Name <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_name_for_ncl_certificate" name="spouse_name_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_name}}" placeholder="Enter Spouse Name !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_name_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_name_for_ncl_certificate"></span>
                                        </div>
                                        <div class="form-group col-sm-6 col-md-4">
                                            <label>2. Type of Org. (Govt/Pvt) Profession/Trae/Business/Agriculture <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_organization_type_for_ncl_certificate" name="spouse_organization_type_for_ncl_certificate" organization_type="spouse_organization_type_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_organization_type}}" placeholder="Type of Organization !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_organization_type_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_organization_type_for_ncl_certificate"></span>
                                        </div>
                                        <div class="form-group col-sm-6 col-md-4">
                                            <label>3. Name of Organization/ Department <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_organization_name_for_ncl_certificate" name="spouse_organization_name_for_ncl_certificate" organization_name="spouse_organization_name_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_organization_name}}" placeholder="Name of Organization !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_organization_name_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_organization_name_for_ncl_certificate"></span>
                                        </div>  
                                        <div class="form-group col-sm-6 col-md-3">
                                            <label>4. Designation/Post Held <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_designation_for_ncl_certificate" name="spouse_designation_for_ncl_certificate" designation="spouse_designation_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_designation}}" placeholder="Enter Designation !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_designation_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_designation_for_ncl_certificate"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>5. Scale of Pay <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_scale_pay_for_ncl_certificate" name="spouse_scale_pay_for_ncl_certificate" scale_pay="spouse_scale_pay_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_scale_pay}}" placeholder="Enter Scale of Pay !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_scale_pay_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_scale_pay_for_ncl_certificate"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>6. Date of Appointment <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_appointment_date_for_ncl_certificate" name="spouse_appointment_date_for_ncl_certificate" appointment_date="spouse_appointment_date_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_appointment_date}}" placeholder="Date of Appointment !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_appointment_date_for_ncl_certificate', spoucegovDetailValidationMessage);">

                                            <span class="error-message error-message-ncl-certificate-spouse_appointment_date_for_ncl_certificate"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>7. Occupation <span class="color-nic-red">*</span></label>
                                            <select id="spouse_occupation_for_nc" name="spouse_occupation_for_nc" class="form-control select2" onchange="checkValidation('ncl-certificate', 'spouse_occupation_for_nc', applicantOccupationValidationMessage); showOtherapplicantOccupationtext(this, 'spouse_other_occupation_text', 'nc');"  data-placeholder="Select Occupation" style="width: 100%;">
                                            </select>
                                            <span class="error-message error-message-ncl-certificate-spouse_occupation_for_nc"></span>

                                            <input type="text" id="spouse_other_occupation_text_for_nc" name="spouse_other_occupation_text_for_nc"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('ncl-certificate', 'spouse_other_occupation_text_for_nc', otherOccupationValidationMessage);"
                                                   style="display: none;">
                                            <span class="error-message error-message-ncl-certificate-spouse_other_occupation_text_for_nc"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>8. Gross annual Salary / Amount <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_annual_salary_for_nc" name="spouse_annual_salary_for_nc"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_annual_salary}}" placeholder="Enter Annual Salary !"  onkeyup="checkNumeric($(this));"
                                                   onblur="NclCertificate.listview.getYearlyIncomeTotalofSpouse(); NclCertificate.listview.getYearlyIncomeTotalofAll(); checkValidation('ncl-certificate', 'spouse_annual_salary_for_nc', spoucegovDetailValidationMessage);">
                                            <span class="error-message error-message-ncl-certificate-spouse_annual_salary_for_nc"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>9. Income From other sources <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_other_income_sources_for_nc" name="spouse_other_income_sources_for_nc"
                                                   maxlength="100" class="form-control"  value="{{ncl_certificate_data.spouse_other_income_sources}}" placeholder="Enter Other Income !"  onkeyup="checkNumeric($(this));"
                                                   onblur="NclCertificate.listview.getYearlyIncomeTotalofSpouse(); NclCertificate.listview.getYearlyIncomeTotalofAll(); checkValidation('ncl-certificate', 'spouse_other_income_sources_for_nc', spoucegovDetailValidationMessage);">
                                            <span class="error-message error-message-ncl-certificate-spouse_other_income_sources_for_nc"></span>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>10. Total</label>
                                            <input type="text" id="spouse_total_for_nc" name="spouse_total_for_nc"
                                                   class="form-control" placeholder="Enter Total Income !"
                                                   onblur="NclCertificate.listview.getYearlyIncomeTotalofAll();" readonly>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-3">
                                            <label>11. Remarks <span class="color-nic-red">*</span></label>
                                            <input type="text" id="spouse_remarks_for_ncl_certificate" name="spouse_remarks_for_ncl_certificate"
                                                   maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_remarks}}" placeholder="Enter Remarks !"
                                                   onblur="checkValidation('ncl-certificate', 'spouse_remarks_for_ncl_certificate', spoucegovDetailValidationMessage);">
                                            <span class="error-message error-message-ncl-certificate-spouse_remarks_for_ncl_certificate"></span>
                                        </div>  
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered table-hover-cells m-0 f-s">
                                    <thead>
                                        <tr class="bg-light-gray">
                                            ...
                                            <th class="p-1" style="min-width: 150px;">Income / Wealth</th>
                                            <th class="p-1" style="min-width: 150px;">Father</th>
                                            <th class="p-1" style="min-width: 150px;">Mother</th>
                                            <th class="p-1" style="min-width: 150px;">Spouse</th>
                                    ...
                                    <tbody id="">
                                        <tr class="p-1">
                                            ...
                                            <td>
                                                <input type="text" id="spouse_land_for_ncl_certificate" name="spouse_land_for_ncl_certificate"
                                                       maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_land}}" placeholder="Enter Agriculture land !"
                                                       onblur="checkValidation('ncl-certificate', 'spouse_land_for_ncl_certificate', spoucegovDetailValidationMessage);">
                                                <span class="error-message error-message-ncl-certificate-spouse_land_for_ncl_certificate"></span>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="p-1">
                                            ...
                                            <td>
                                                <input type="text" id="spouse_location_for_ncl_certificate" name="spouse_location_for_ncl_certificate"
                                                       maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_location}}" placeholder="Enter Location !"
                                                       onblur="checkValidation('ncl-certificate', 'spouse_location_for_ncl_certificate', spoucegovDetailValidationMessage);">
                                                <span class="error-message error-message-ncl-certificate-spouse_location_for_ncl_certificate"></span>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="p-1">
                                            ...
                                            <td>
                                                <input type="text" id="spouse_sizeofholding_for_ncl_certificate" name="spouse_sizeofholding_for_ncl_certificate"
                                                       maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_sizeofholding}}" placeholder="Enter Size of holding !"
                                                       onblur="checkValidation('ncl-certificate', 'spouse_sizeofholding_for_ncl_certificate', spoucegovDetailValidationMessage);">
                                                <span class="error-message error-message-ncl-certificate-spouse_sizeofholding_for_ncl_certificate"></span>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="p-1">
                                            ...
                                            <td>
                                                <input type="text" id="spouse_typeofirrigated_for_ncl_certificate" name="spouse_typeofirrigated_for_ncl_certificate"
                                                       maxlength="100" class="form-control" value="{{ncl_certificate_data.spouse_typeofirrigated}}" placeholder="Type of irrigated !"
                                                       onblur="checkValidation('ncl-certificate', 'spouse_typeofirrigated_for_ncl_certificate', spoucegovDetailValidationMessage);">
                                                <span class="error-message error-message-ncl-certificate-spouse_typeofirrigated_for_ncl_certificate"></span>
                                            </td>
                                            <td>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="cropsfruit_for_ncl_certificate" name="cropsfruit_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'cropsfruit_for_ncl_certificate', detailValidationMessage);">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="location_for_ncl_certificate" name="location_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'location_for_ncl_certificate', detailValidationMessage);">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="areaofplantation_for_ncl_certificate" name="areaofplantation_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'areaofplantation_for_ncl_certificate', detailValidationMessage);">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="locationpoperty_for_ncl_certificate" name="locationpoperty_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'locationpoperty_for_ncl_certificate', detailValidationMessage);">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="detailproperty_for_ncl_certificate" name="detailproperty_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'detailproperty_for_ncl_certificate', detailValidationMessage);">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" id="usetowhich_for_ncl_certificate" name="usetowhich_for_ncl_certificate"
                                           ...
                                           onblur="checkValidation('ncl-certificate', 'usetowhich_for_ncl_certificate', detailValidationMessage);">
                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <span class="error-message error-message-ncl-certificate-obc_certificate_date"></span>
                                </div>
                                <div class="form-group col-sm-6 ">
                                    ...
                                    <span class="error-message error-message-ncl-certificate-income_certificate_date"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="applicant_photo_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Photo (Latest). <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                                ...
                                <div class="col-sm-12" id="applicant_photo_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Photo (Latest). <span style="color: red;">*</span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="self_birth_certificate_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Birth Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="self_birth_certificate_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Birth Certificate <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="leaving_certificate_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Leaving Certificate / Bonofied Certificate Form <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="leaving_certificate_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Leaving Certificate / Bonofied Certificate Form <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="aadhar_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Aadhaar Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="aadhar_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Aadhaar Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="election_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                    <div class="error-message error-message-ncl-certificate-election_card_doc_for_ncl_certificate"></div>
                                </div>
                                <div class="col-sm-12" id="election_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant Original Election Card <span style="color: red;">* </span></label><br>
                                    <a target="_blank" id="election_card_doc_download"><label id="election_card_doc_name_image_for_ncl_certificate" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_ncl_certificate_{{VALUE_EIGHT}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="obc_certificate_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant OBC Certificate (First issued and Original copy upload) <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="obc_certificate_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Applicant OBC Certificate <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="father_aadhar_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Father Aadhar Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="father_aadhar_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Father Aadhar Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="father_election_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Father Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="father_election_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Father Election Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="community_certificate_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Community Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                    <div class="error-message error-message-ncl-certificate-community_certificate_doc_for_ncl_certificate"></div>
                                </div>
                                <div class="col-sm-12" id="community_certificate_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Community Certificate <span style="color: red;">* </span></label><br>
                                    <a target="_blank" id="community_certificate_doc_download"><label id="community_certificate_doc_name_image_for_ncl_certificate" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_ncl_certificate_{{VALUE_FIFTEEN}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="mother_election_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Mother Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="mother_election_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Mother Election Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="mother_aadhar_card_doc_container_for_ncl_certificate">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Mother Aadhar Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="mother_aadhar_card_doc_name_container_for_ncl_certificate" style="display: none;">
                                    <label><span class="doc_no_for_ncl_certificate"></span> Upload Applicant Mother Aadhar Card <span style="color: red;">* </span></label><br>

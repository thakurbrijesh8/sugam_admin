...
<form role="form" id="approve_heirship_form" name="approve_heirship_form" onsubmit="return false;" style="font-size: 14px;">
    <input type="hidden" id="heirship_id_for_heirship_approve" name="heirship_id_for_heirship_approve" value="{{heirship_id}}">
    <div class="card-body p-b-0px text-left">
        <div class="row">
            <div class="col-sm-12 text-center">
                <span class="error-message error-message-heirship-approve f-w-b" style="border-bottom: 2px solid red;"></span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <textarea id="remarks_for_heirship_approve" name="remarks_for_heirship_approve" class="form-control"
                          onblur="checkValidation('heirship-approve', 'remarks_for_heirship_approve', remarksValidationMessage);"
                          placeholder="Remarks !" maxlength="1500" rows="3"></textarea>
                <span class="error-message error-message-heirship-approve-remarks_for_heirship_approve"></span>
            </div>
        </div>
        <hr class="m-b-1rem">
        <div class="form-group">
            <button type="button" id="submit_btn_for_heirship_approve" class="btn btn-sm btn-success" onclick="Heirship.listview.approveApplication();"

...
<form role="form" id="reject_domicile_form" name="reject_domicile_form" onsubmit="return false;" style="font-size: 14px;">
    <input type="hidden" id="domicile_certificate_id_for_domicile_certificate_reject" name="domicile_certificate_id_for_domicile_certificate_reject" value="{{domicile_certificate_id}}">
    <div class="card-body p-b-0px text-left">
        <div class="row">
            <div class="col-sm-12 text-center">
                <span class="error-message error-message-domicile-reject f-w-b" style="border-bottom: 2px solid red;"></span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <textarea id="remarks_for_domicile_certificate_reject" name="remarks_for_domicile_certificate_reject" class="form-control"
                          onblur="checkValidation('domicile-approve', 'remarks_for_domicile_certificate_reject', remarksValidationMessage);"
                          placeholder="Remarks !" maxlength="1500" rows="3"></textarea>
                <span class="error-message error-message-domicile-approve-remarks_for_domicile_certificate_reject"></span>
            </div>
        </div>
        <hr class="m-b-1rem">
        <div class="form-group">
            <button type="button" id="submit_btn_for_domicile_reject" class="btn btn-sm btn-danger" onclick="Domicile.listview.rejectApplication();"

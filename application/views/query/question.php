<div id="query_container">
    ...
    <div class="timeline-item">
        <span class="time text-dark f-w-b"><i class="fas fa-clock"></i> Query By & Date Time : <span id="query_time_for_query" class="color-nic-red">{{query_by_name}} ( {{datetime_text}} )</span></span>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="btn btn-success btn-sm pull-right"
                                    onclick="addDocumentRow({});"><i class="fas fa-plus" style="margin-right: 4px;"></i>Add More Documents</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="timeline-footer" style="padding-top: 0px;">
            <a class="btn btn-success btn-sm" id="submit_btn_for_query"
               onclick="askForSubmitQueryDetails();"><i class="fas fa-save" style="margin-right: 4px;"></i>Submit</a>
        </div>
    </div>
</div>
<?php
$barcode_number = generate_barcode_number(VALUE_THIRTEEN, $fof_data['form_copy_id']);
        ...
        <td style="vertical-align: bottom; width: 35%;">
            <table>
                ...
                <tr>
                    ...
                    <td class="footer-title"><b> : <?php echo $fof_data['copy_created_time'] != '0000-00-00 00:00:00' ? convert_to_new_datetime_format($fof_data['copy_created_time']) : ''; ?></b></td>
                </tr>
            </table>
        </td>

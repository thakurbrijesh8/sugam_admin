<?php
$barcode_number = generate_barcode_number(VALUE_NINETEEN, $birth_certificate_data['birth_certificate_id']);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        $district_text = isset($taluka_array[$birth_certificate_data['district']]) ? $taluka_array[$birth_certificate_data['district']] : '-';
        $date_of_birth = date("d-m-Y", strtotime($birth_certificate_data['applicant_dob']));
        $date_of_registration = date("d-m-Y", strtotime($birth_certificate_data['registration_date']));
        ?>
                ...
                <div style="border: 1.5px solid red; padding: 8px; height: 100%;">
                    <table>
                        <tr>
                            ...
                            <td class="v-a-t t-a-c"><span class="ff-arialunicodems f-s-18">प्रपत्र</span> - 5 / FORM - 5</td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                    ...
                    <table>
                        <tr>
                            <td class="ff-arialunicodems t-a-c" style="font-size: 30px; line-height: 20px;">जन्म प्रमाण - पत्र</td>
                        </tr>
                        <tr>
                            <td class="t-a-c" style="font-size: 16px; line-height: 25px;">BIRTH CERTIFICATE</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="t-a-c">(Issued under Section 12/17 of the Registration of Birth & Death Act, 1969 and</td>
                        </tr>
                        <tr>
                            <td class="t-a-c l-h-10">Rule 8/13 of the Daman & Diu Registration of Birth and Death Rules, 2000)</td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 10px;">
                        <tr>
                            <td class="ff-arialunicodems">
                                यह प्रमाणित किया जाता है कि निम्नलिखित सूचना जन्म के मूल लेख से ली गई है, जो की
                            </td>
                    ...
                    <table class="p-lr-10px" style="margin-top: 10px;">
                        ...
                        <tr>
                            ...
                            <td class="ff-timesnewroman bb-2px">
                                <?php echo $birth_certificate_data['applicant_name']; ?>
                            </td>
                    ...
                    <table class="p-lr-10px" style="margin-top: 20px;">
                        <tr>
                            <td style="width: 70%;"><span class="ff-arialunicodems">नाम</span> / Name : <span class="ff-timesnewroman"><?php echo $birth_certificate_data['applicant_name']; ?></span></td>
                            <td><span class="ff-arialunicodems">लिंग</span> / Sex : 
                                <span class="ff-timesnewroman">
                                    <?php
                                    if ($birth_certificate_data['gender'] == '1') {
                                        echo 'Male';
                                    } else if ($birth_certificate_data['gender'] == '2') {
                                        echo 'Female';
                                    } else if ($birth_certificate_data['gender'] == '3') {
                                        echo 'Transgender';
                                    } else if ($birth_certificate_data['gender'] == '4') {
                                        echo 'Not Applicable';
                                    }
                                    ?>
                                </span>
                    ...
                    <table class="p-lr-10px" style="margin-top: 8px;">
                        <tr>
                            <td><span class="ff-arialunicodems">जन्म तिथि</span> / Date of Birth : <span class="ff-timesnewroman"><?php echo $date_of_birth; ?></span></td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 8px;">
                        <tr>
                            <td><span class="ff-arialunicodems">जन्म स्थान</span> / Place of Birth : <span class="ff-timesnewroman"><?php echo $birth_certificate_data['applicant_born_place']; ?></span></td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 8px;">
                        <tr>
                            <td><span class="ff-arialunicodems">माता का नाम</span> / Name of Mother : <span class="ff-timesnewroman"><?php echo $birth_certificate_data['mother_name']; ?></span></td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 8px;">
                        <tr>
                            <td><span class="ff-arialunicodems">पिता का नाम</span> / Name of Father : <span class="ff-timesnewroman"><?php echo $birth_certificate_data['father_name']; ?></span></td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 8px;">
                        <tr>
                            <td class="ff-arialunicodems" style="width: 51%;">बच्चे के जन्म के समय माता पिता का पता /</td>
                            <td class="ff-arialunicodems">माता पिता का स्थायी पता /</td>
                        </tr>
                        <tr>
                            <td style="width: 51%;">
                    ...
                    <table class="p-lr-10px">
                        <tr>
                            <td class="ff-timesnewroman v-a-t" style="height: 90px; width: 51%; padding-left: 0px; padding-right: 5px; line-height: 20px;">
                                <?php echo $birth_certificate_data['communication_address']; ?>
                            </td>
                            <td class="ff-timesnewroman v-a-t" style="height: 90px; padding-left: 0px; padding-right: 0px; line-height: 20px;">
                                <?php echo $birth_certificate_data['applicant_address']; ?>
                            </td>
                        </tr>
                    </table>
                    <table class="p-lr-10px">
                        <tr>
                            <td style="width: 51%;">
                                ...
                                <span class="ff-timesnewroman" style="font-size: 15px;"><?php echo $birth_certificate_data['registration_number']; ?></span>
                            </td>
                            <td>
                                <span class="ff-arialunicodems" style="letter-spacing: 0px;">पंजीकरण दिनांक</span>/Date of Registration :
                                <span class="ff-timesnewroman" style="font-size: 15px;"><?php echo $birth_certificate_data['is_date_or_year'] == VALUE_ONE ? $date_of_registration : ($birth_certificate_data['is_date_or_year'] == VALUE_TWO ? $birth_certificate_data['registration_year'] : '--------'); ?></span>
                            </td>
                        </tr>
                    </table>
                    <table class="p-lr-10px" style="margin-top: 10px;">
                        <tr>
                            <td class="v-a-t" style="height: 40px;">
                                ...
                                <?php echo $birth_certificate_data['remarks']; ?>
                            </td>
                        </tr>
                    </table>
                    <table class="p-lr-10px">
                    ...
                    <table style="border: 1px solid black; margin: 10px 10% 0% 10%;">
                        <tr>
                            <td class="t-a-c"><span style="font-family: arial_unicode_ms; font-size: 13px;">"प्रत्येक जन्म एवं मृत्यु का पंजीकरण सुनिश्चित करें / Ensure registration of every birth and death"</span></td>
                        </tr>
                    </table>
                </div>
            </div>

                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" id="email_for_oc" name="email"
                                           ...
                                           value="{{obc_certificate_data.email}}">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label>7. Applicant's Aadhaar Number</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <span class="error-message error-message-obc-certificate-election_no_for_oc"></span>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" id="applicant_dob_for_oc" name="applicant_dob"  class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select id="applicant_education_for_oc" name="applicant_education" class="form-control select2" onchange="checkValidation('obc-certificate', 'applicant_education_for_oc', applicantEducationValidationMessage); showOtherapplicantEducationtext(this, 'applicant_education_other_div', 'obc_certificate');" data-placeholder="Select Education" style="width: 100%;">
                                    </select>
                                    <span class="error-message error-message-obc-certificate-applicant_education_for_oc"></span>
                                </div>
                                <div class="form-group col-sm-4 col-md-4" id="applicant_education_other_div_for_obc_certificate" style="display: none;">

                                    <label>19.1 Other Education Detail</label>
                                    <input type="text" id="other_education_for_oc" name="other_education"
                                           maxlength="100" class="form-control" value="{{obc_certificate_data.other_education}}" placeholder="Enter Other Education !" onchange="checkValidation('obc-certificate', 'other_education_for_oc', applicantEducationValidationMessage);"
                                           >
                                    <span class="error-message error-message-obc-certificate-other_education_for_oc"></span>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label>11.1 Name of School / Collage / Institute <span class="color-nic-red">*</span></label>
                                    <input type="text" id="name_of_school_for_oc" name="name_of_school"
                                           maxlength="100" class="form-control" value="{{obc_certificate_data.name_of_school}}" placeholder="Enter Name of School / Collage / Institute !" onblur="checkValidation('obc-certificate', 'name_of_school_for_oc', schoolNameValidationMessage);"
                                           >
                                    <span class="error-message error-message-obc-certificate-name_of_school_for_oc"></span>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-3 col-md-43" style="margin-top:22px">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <label>16.Select Caste <span class="color-nic-red">*</span></label>
                                    <select id="obccaste_for_oc" name="obccaste" class="form-control select2" onchange="checkValidation('obc-certificate', 'obccaste_for_oc', religionValidationMessage);" data-placeholder="Select Caste" style="width: 100%;">
                                    </select>
                                ...
                                <!-- <div class="row"> -->
                                <div class="form-group col-sm-4">
                                    <label>17. Applicant Religion.<span class="color-nic-red">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-sm-4">
                                    <label>18. Nearest Police Station. <span class="color-nic-red">*</span></label>
                            ...
                            <!--    <div class="row">
                              <div class="form-group col-sm-6">
                                  ...
                                  <select id="applicant_education_for_oc" name="applicant_education" class="form-control select2" onchange="checkValidation('obc-certificate', 'applicant_education_for_oc', applicantEducationValidationMessage);" data-placeholder="Select Education" style="width: 100%;">
                                  </select>
                                  <span class="error-message error-message-obc-certificate-applicant_education_for_oc"></span>
                              </div>
                              <div class="form-group col-sm-6 col-md-6">
                            ...
                            <!--      <div class="form-group col-sm-6 col-md-6">
                                     <label>9.1 Applicant Occupation<span class="color-nic-red">*</span></label>
                            ...
                            <div class="row ">
                                <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <select id="occupation_for_oc" name="occupation" class="form-control select2" onchange="checkValidation('obc-certificate', 'occupation_for_oc', applicantOccupationValidationMessage); showOtherapplicantOccupationtext(this, 'applicant_occupation_other_div', 'obc_certificate');" data-placeholder="Select Occupation" style="width: 100%;">
                                    </select>
                                    <span class="error-message error-message-obc-certificate-occupation_for_oc"></span>
                                </div>
                                <div class="form-group col-sm-6 col-md-6" id="applicant_occupation_other_div_for_obc_certificate" style="display: none;">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-4 col-md-4">
                                                            ...
                                                            <label>20.4.1 District <span class="color-nic-red">*</span></label>
                                                            <div class="">
                                                        ...
                                                        <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                            <label>20.4.2 Select City<span class="color-nic-red">*</span></label>
                                                            <div class="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-4 col-md-4">
                                                            ...
                                                            <select id="father_caste_for_oc" name="father_caste" class="form-control select2"  data-placeholder="Select Caste" style="width: 100%;" onchange="checkValidation('obc-certificate', 'father_religion_for_oc', castesValidationMessage);">
                                                            </select>
                                                        ...
                                                        <div class="form-group col-sm-4 col-md-4 if_father_alive_item_container_for_obc_certificate">
                                                            <label>20.7 Father Annual Income (Excluding Salary & Agriculture Income)<span class="color-nic-red">*</span></label>
                                                            <input type="checkNumeric" id="father_annual_income_for_oc" name="father_annual_income" class="form-control" placeholder="Enter Annual Income !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('obc-certificate', 'father_annual_income_for_oc', annualIncomeValidationMessage); ObcCertificate.listview.getYearlyIncomeTotal($(this));" value="{{father_data.father_annual_income}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6 col-md-6 if_father_alive_item_container_for_obc_certificate">
                                                            <label>20.8 Father's Aadhaar Number </label>
                                                            <div class="input-group">
                                                        ...
                                                        <div class="form-group col-sm-6 col-md-6 if_father_alive_item_container_for_obc_certificate">
                                                            <label>20.9 Father's Election Number </label>
                                                            <div class="input-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6 col-md-6 if_father_alive_item_container_for_obc_certificate">
                                                            <label>20.10 Father's occupation. <span class="color-nic-red">*</span></label>
                                                        ...
                                                        <div class="form-group col-sm-6 col-md-6">
                                                            <div class="father_other_occupation_div_for_oc" style="display: none;">
                                                                <label>20.10.1 Other Occupation Detail</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                                ...
                                                <div class="p-1 flex-fill" style="overflow: hidden">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    ...
                                                                    <div class="">
                                                                        <select class="form-control select2" id="grandfather_born_place_district_for_oc" name="grandfather_born_place_district"
                                                                                ...
                                                                                onchange="ObcCertificate.listview.grandfatherBornCityChangeEvent($(this));"></select>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    <label>22.4 Original Native of<span class="color-nic-red">*</span></label><br/>
                                                                    <label>22.4.1 District <span class="color-nic-red">*</span></label>
                                                                    <div class="">
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                                    <label>22.4.2 Select City<span class="color-nic-red">*</span></label>
                                                                    <div class="">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-4 col-md-4 if_grandfather_alive_item_container_for_obc_certificate">
                                                                    <label>22.7 Grandfather's Aadhaar Number </label>
                                                                    <div class="input-group">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <div id="spouse_alive_container_for_obc_certificate"></div>
                                                                    <span class="error-message error-message-obc-certificate-spouse_alive_for_obc_certificate"></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-6 col-md-6">
                                                                    ...
                                                                    <input type="text" id="spouse_name_for_oc" name="spouse_name"
                                                                           maxlength="100" class="form-control" value="{{spouse_data.spouse_name}}" placeholder="Enter Spouse Name !" onblur="checkValidation('obc-certificate', 'spouse_name_for_oc', spouseNameValidationMessage);"
                                                                           >
                                                                ...
                                                                <div class="form-group col-sm-6 col-md-6">
                                                                    ...
                                                                    <input type="text" id="spouse_nationality_for_oc" name="spouse_nationality" class="form-control" placeholder="Enter Spouse's Nationality!"
                                                                           maxlength="100" onblur="checkValidation('obc-certificate', 'spouse_nationality_for_oc', applicantNationalityValidationMessage);" value="{{spouse_data.spouse_nationality}}">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="spouse_born_place_state_for_oc" name="spouse_born_place_state" class="form-control select2"
                                                                                data-placeholder="Select State/UT"
                                                                                onchange="checkValidation('oc', 'spouse_born_place_state_for_oc', selectStateValidationMessage);
                                                                                        ObcCertificate.listview.getDistrictData($(this), 'oc', 'spouse_born_place');">
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="spouse_born_place_district_for_oc" name="spouse_born_place_district" class="form-control select2"
                                                                                data-placeholder="Select District"
                                                                                onchange="checkValidation('oc', 'spouse_born_place_district_for_oc', selectDistrictValidationMessage);
                                                                                        ObcCertificate.listview.getVillageData($(this), 'oc', 'spouse_born_place');">
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                                    ...
                                                                    <select id="spouse_born_place_village_for_oc" name="spouse_born_place_village" class="form-control select2"
                                                                            data-placeholder="Select Village" onchange="checkValidation('oc', 'spouse_born_place_village_for_oc', selectVillageValidationMessage);">
                                                                    </select>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="spouse_native_place_state_for_oc" name="spouse_native_place_state" class="form-control select2"
                                                                                data-placeholder="Select State/UT"
                                                                                onchange="checkValidation('oc', 'spouse_native_place_state_for_oc', selectStateValidationMessage);
                                                                                        ObcCertificate.listview.getDistrictData($(this), 'oc', 'spouse_native_place');">
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="spouse_native_place_district_for_oc" name="spouse_native_place_district" class="form-control select2"
                                                                                data-placeholder="Select District"
                                                                                onchange="checkValidation('oc', 'spouse_native_place_district_for_oc', selectDistrictValidationMessage);
                                                                                        ObcCertificate.listview.getVillageData($(this), 'oc', 'spouse_native_place');">
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                                                    ...
                                                                    <select id="spouse_native_place_village_for_oc" name="spouse_native_place_village" class="form-control select2"
                                                                            data-placeholder="Select Village" onchange="checkValidation('oc', 'spouse_native_place_village_for_oc', selectVillageValidationMessage);">
                                                                    </select>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    ...
                                                                    <input type="text" id="spouse_religion_for_oc" name="spouse_religion_for_oc" class="form-control" placeholder="Enter Religion !" maxlength="100" value="{{spouse_data.spouse_religion}}">
                                                                    <span class="error-message error-message-obc-certificate-spouse_religion_for_oc"></span>
                                                                </div>
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    <label>23.6 Spouse Caste<span class="color-nic-red">*</span></label>
                                                                    <input type="text" id="spouse_caste" name="spouse_caste" class="form-control" onblur="checkValidation('obc-certificate', 'spouse_caste', castesValidationMessage);" placeholder="Enter Spouse Caste !"
                                                                           maxlength="100"  value="{{spouse_data.spouse_caste}}">
                                                                    <span class="error-message error-message-obc-certificate-spouse_caste"></span>
                                                                </div>

                                                                <div class="form-group col-sm-4 col-md-4 if_spouse_alive_item_container_for_obc_certificate">
                                                                    <label>23.7 Spouse Annual Income<span class="color-nic-red">*</span></label>
                                                                    <input type="checkNumeric" id="spouse_annual_income_for_oc" name="spouse_annual_income" class="form-control" placeholder="Enter Annual Income !" maxlength="100"  onkeyup="checkNumeric($(this));" onblur="checkValidation('obc-certificate', 'spouse_annual_income_for_oc', annualIncomeValidationMessage); ObcCertificate.listview.getYearlyIncomeTotal($(this));"value="{{spouse_data.spouse_annual_income}}">
                                                                    <span class="error-message error-message-obc-certificate-spouse_annual_income_for_oc"></span>
                                                                </div>
                                                            </div>
                                                            <div class="row">

                                                                <div class="form-group col-sm-4 col-md-4 if_spouse_alive_item_container_for_obc_certificate">
                                                                    <label>23.8 Spouse's Aadhaar Number </label>
                                                                    <div class="input-group">
                                                                        <input type="text" id="spouse_aadhaar_for_oc" name="spouse_aadhaar" class="form-control" placeholder="Enter Aadhaar Number"
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4 if_spouse_alive_item_container_for_obc_certificate">
                                                                    <label>23.9 Spouse's Election Number </label>
                                                                    <div class="input-group">
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4 if_spouse_alive_item_container_for_obc_certificate">
                                                                    <label>23.10 Spouse's Occupation. <span class="color-nic-red">*</span></label>
                                                                    <select id="spouse_occupation_for_oc" name="spouse_occupation" class="form-control select2" onchange="checkValidation('obc-certificate', 'spouse_occupation_for_oc', applicantOccupationValidationMessage); ObcCertificate.listview.partASChangeEvent($(this))" data-placeholder="Select Occupation" style="width: 100%;">
                                                                    </select>
                                                                ...
                                                                <div class="form-group col-sm-4 col-md-4">
                                                                    <div class="spouse_other_occupation_div_for_oc" style="display: none;">
                                                                        <label>23.10.1 Other Occupation Detail</label>
                                                                        <input type="text" id="spouse_other_occupation_for_oc" name="spouse_other_occupation"
                                                                               maxlength="100" class="form-control" value="{{spouse_data.spouse_other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('obc-certificate', 'spouse_other_occupation_for_oc', otherOccupationValidationMessage);"
                                                                               >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card collapsed-card part_a_div">
                                        <div class="card-header bg-nic-blue pt-1" >
                                            <h3 class="card-title">24. PART A - Constitutional Post</h3>
                                        ...
                                        <div class="card-body border-nic-blue pt-1 part_a_div" style="display: none;">
                                            <!--    <div class="card-body border-nic-blue pt-1 part_a_div"> -->
                                            <div class="">
                                                            ...
                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                <thead>
                                                                    <tr class="bg-light-gray">
                                                                        ...
                                                                        <th class="p-1 f-gov-job d-none" style="min-width: 150px;">Father</th>
                                                                        <th class="p-1 m-gov-job d-none" style="min-width: 150px;">Mother</th>
                                                                        <th class="p-1 s-gov-job d-none" style="min-width: 150px;" >Spouse Details</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody id="">
                                                                    <tr class="p-1">
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_designation_for_oc" name="spouce_designation_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_designation.spouce_designation}}" placeholder="Enter Designation !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_designation_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_designation_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card collapsed-card part_b_div" style="display: none;">
                                        <div class="card-header bg-nic-blue pt-1" >
                                            <h3 class="card-title">25. PART B - Government Services </h3>
                                                ...
                                                <div class="p-1 flex-fill">
                                                        ...
                                                        <div class="card-header" >
                                                            <div class="row">
                                                                <div class="col-12 f-w-b">
                                                                    <h6 style="font-weight: bold; ">25.1. Government Services </h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                ...
                                                                <tbody id="">
                                                                    <tr class="p-1">
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_services_for_oc" name="spouce_services_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_services.spouce_services}}" placeholder="Enter Services !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_services_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_services_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>2</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_designation_b_for_oc" name="spouce_designation_b_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_designation_b.spouce_designation_b}}" placeholder="Enter Designation !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_designation_b_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_designation_b_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>3</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_scale_of_pay_for_oc" name="spouce_scale_of_pay_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_scale_of_pay.spouce_scale_of_pay}}" placeholder="Enter Scale of Pay !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_scale_of_pay_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_scale_of_pay_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>4</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_appointment_date_for_oc" name="spouce_appointment_date_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_appointment_date.spouce_appointment_date}}" placeholder="Enter Date of the Appointment !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_appointment_date_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_appointment_date_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>5</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_promotion_age_for_oc" name="spouce_promotion_age_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_promotion_age.spouce_promotion_age}}" placeholder="Enter Age at the time of Promotion !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_promotion_age_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_promotion_age_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div class="card"  style="background-color: #F8F8F8;">
                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                            <div class="row">
                                                                <div class="col-12 f-w-b">
                                                                    <h6 style="font-weight: bold; "> 25.2. Employment in International Organization e.g, UN, NICEF, WHO, </h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                ...
                                                                <tbody id="">
                                                                    <tr class="p-1">
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_organization_name_for_oc" name="spouce_organization_name_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_organization_name.spouce_organization_name}}" placeholder="Enter Name of orgnization !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_organization_name_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_organization_name_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>2</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_designation_b1_for_oc" name="spouce_designation_b1_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_designation_b1.spouce_designation_b1}}" placeholder="Enter Designation !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_designation_b1_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_designation_b1_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>3</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_service_period_for_oc" name="spouce_service_period_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_service_period.spouce_service_period}}" placeholder="Enter Period of Sevice !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_service_period_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_service_period_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div class="card" style="background-color: #F8F8F8;">
                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                            <div class="row">
                                                                <div class="col-12 f-w-b">
                                                                    <h6 style="font-weight: bold; "> 25.3. Death/Permanent Incapacitation (Omit if not applicable)</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                ...
                                                                <tbody id="">
                                                                    <tr class="p-1">
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_permanent_incapacitation_service_for_oc" name="spouce_permanent_incapacitation_service_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_permanent_incapacitation_service.spouce_permanent_incapacitation_service}}" placeholder="Enter Date !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_permanent_incapacitation_service_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_permanent_incapacitation_service_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>2</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_permanent_incapacitation_for_oc" name="spouce_permanent_incapacitation_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_permanent_incapacitation.spouce_permanent_incapacitation}}" placeholder="Enter Details of Incapacitation!"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_permanent_incapacitation_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_permanent_incapacitation_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card collapsed-card part_c_div" style="display: none;">
                                        <div class="card-header bg-nic-blue pt-1" >
                                            <h3 class="card-title">26. PART C - Employment in Public Sector Undertaking etc </h3>
                                                ...
                                                <div class="p-1 flex-fill">
                                                    ...
                                                    <div class="card" style="background-color: #F8F8F8;">
                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                            <div class="row">
                                                                <div class="col-12 f-w-b">
                                                                    <h6 style="font-weight: bold; ">  26. Employment in Public Sector Undertaking etc.</h6> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                ...
                                                                <tbody id="">
                                                                    <tr class="p-1">
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_organization_name_partc_for_oc" name="spouce_organization_name_partc_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_organization_name_partc.spouce_organization_name_partc}}" placeholder="Enter Name of Organization !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_organization_name_partc_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_organization_name_partc_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>2</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_designation_partc_for_oc" name="spouce_designation_partc_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_designation_partc.spouce_designation_partc}}" placeholder="Enter Designation !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_designation_partc_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_designation_partc_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="p-1">
                                                                        <td><b>3</b></td>
                                                                        ...
                                                                        <td class="p-1 s-gov-job d-none">
                                                                            <input type="text" id="spouce_date_of_appointmet_partc_for_oc" name="spouce_date_of_appointmet_partc_for_oc"
                                                                                   maxlength="100" class="form-control" value="{{f_date_of_appointmet_partc.spouce_date_of_appointmet_partc}}" placeholder="Enter Date of Appintment !"
                                                                                   onblur="checkValidation('obc-certificate', 'spouce_date_of_appointmet_partc_for_oc', spoucegovDetailValidationMessage);">
                                                                            <span class="error-message error-message-obc-certificate-spouce_date_of_appointmet_partc_for_oc"></span>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card collapsed-card part_d_div" style="display: none;">
                                                <div class="card-header bg-nic-blue pt-1" >
                                                    <h3 class="card-title">27. PART D - Armed Forces including Para-military Forces</h3>
                                                        ...
                                                        <div class="p-1 flex-fill">
                                                            ...
                                                            <div class="card" style="background-color: #F8F8F8;">
                                                                <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                                    <div class="row">
                                                                        <div class="col-12 f-w-b">
                                                                            <h6 style="font-weight: bold; "> 27. Armed Forces including Para-military Forces(This will no include persons holing Civil posts) </h6>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                        ...
                                                                        <tbody id="">
                                                                            <tr class="p-1">
                                                                                ...
                                                                                <td class="p-1 s-gov-job d-none">
                                                                                    <input type="text" id="spouce_designation_partd_for_oc" name="spouce_designation_partd_for_oc"
                                                                                           maxlength="100" class="form-control" value="{{f_designation_partd.spouce_designation_partd}}" placeholder="Enter Designation !"
                                                                                           onblur="checkValidation('obc-certificate', 'spouce_designation_partd_for_oc', spoucegovDetailValidationMessage);">
                                                                                    <span class="error-message error-message-obc-certificate-spouce_designation_partd_for_oc"></span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="p-1">
                                                                                <td><b>2</b></td>
                                                                                ...
                                                                                <td class="p-1 s-gov-job d-none">
                                                                                    <input type="text" id="spouce_scale_of_pay_partd_for_oc" name="spouce_scale_of_pay_partd_for_oc"
                                                                                           maxlength="100" class="form-control" value="{{f_scale_of_pay_partd.spouce_scale_of_pay_partd}}" placeholder="Enter Scale of Pay !"
                                                                                           onblur="checkValidation('obc-certificate', 'spouce_scale_of_pay_partd_for_oc', spoucegovDetailValidationMessage);">
                                                                                    <span class="error-message error-message-obc-certificate-spouce_scale_of_pay_partd_for_oc"></span>
                                                                                </td>
                                                                            </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card collapsed-card part_e_div" style="display: none;">
                                                        <div class="card-header bg-nic-blue pt-1" >
                                                            <h3 class="card-title">28. PART E - Professional Class</h3>
                                                                ...
                                                                <div class="p-1 flex-fill">
                                                                    ...
                                                                    <div class="card" style="background-color: #F8F8F8;">
                                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                                            <div class="row">
                                                                                <div class="col-12 f-w-b">
                                                                                    <h6 style="font-weight: bold; ">28. Professional Class (Other then these covered in item No. B & C) and those engaged in trade,  Business and Industry.</h6>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                                ...
                                                                                <tbody id="">
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_occupation_family_for_oc" name="spouce_occupation_family_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_occupation.spouce_occupation_family}}" placeholder="Enter Occupation/Profession !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_occupation_family_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_occupation_family_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card collapsed-card part_f_div" style="display: none;">
                                                        <div class="card-header bg-nic-blue pt-1" >
                                                            <h3 class="card-title">29. PART F - PROPERTY- OWNERS</h3>
                                                                ...
                                                                <div class="p-1 flex-fill">
                                                                    ...
                                                                    <div class="card" style="background-color: #F8F8F8;">
                                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                                            <div class="row">
                                                                                <div class="col-12 f-w-b">
                                                                                    <h6 style="font-weight: bold; ">29.1.  Agricultural Land Holding: Owned  by mother, Father & Minor children  </h6>        
                                                                            ...
                                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                                ...
                                                                                <tbody id="">
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_location_for_oc" name="spouce_location_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_location.spouce_location}}" placeholder="Enter Location !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_location_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_location_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="p-1">
                                                                                        <td><b>2</b></td>
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_size_of_holding_for_oc" name="spouce_size_of_holding_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_size_of_holding.spouce_size_of_holding}}" placeholder="Enter Size of holding !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_size_of_holding_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_size_of_holding_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_irrigated_for_oc" name="spouce_irrigated_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_irrigated.spouce_irrigated}}" placeholder="Enter Size of holding !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_irrigated_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_irrigated_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_perecentage_of_irrigated_for_oc" name="spouce_perecentage_of_irrigated_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_perecentage_of_irrigated.spouce_perecentage_of_irrigated}}" placeholder="Enter Detail !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_perecentage_of_irrigated_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_perecentage_of_irrigated_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_ceiling_low_for_oc" name="spouce_ceiling_low_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_ceiling_low.spouce_ceiling_low}}" placeholder="Enter Detail !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_ceiling_low_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_ceiling_low_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                ...
                                                                                <td class="p-1 s-gov-job d-none">
                                                                                    <input type="text" id="spouce_total_percentage_for_oc" name="spouce_total_percentage_for_oc"
                                                                                           maxlength="100" class="form-control" value="{{f_total_percentage.spouce_total_percentage}}" placeholder="Enter Percentage !"
                                                                                           onblur="checkValidation('obc-certificate', 'spouce_total_percentage_for_oc', spoucegovDetailValidationMessage);">
                                                                                    <span class="error-message error-message-obc-certificate-spouce_total_percentage_for_oc"></span>
                                                                                </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <div class="card" style="background-color: #F8F8F8;">
                                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                                            <div class="row">
                                                                                <div class="col-12 f-w-b">
                                                                                    <h6 style="font-weight: bold; ">29.2.  Plantation </h6>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                                ...
                                                                                <tbody id="">
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_crops_for_oc" name="spouce_crops_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_crops.spouce_crops}}" placeholder="Enter Crops/Fruit !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_crops_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_crops_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="p-1">
                                                                                        <td><b>2</b></td>
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_location_partf_for_oc" name="spouce_location_partf_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_location_partf.spouce_location_partf}}" placeholder="Enter Location !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_location_partf_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_location_partf_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="p-1">
                                                                                        <td><b>3</b></td>
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_area_plantation_for_oc" name="spouce_area_plantation_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_area_plantation.spouce_area_plantation}}" placeholder="Enter Area of Plantation !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_area_plantation_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_area_plantation_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                    ...
                                                                    <div class="card" style="background-color: #F8F8F8;">
                                                                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                                                                            <div class="row">
                                                                                <div class="col-12 f-w-b">
                                                                                    <h6 style="font-weight: bold; ">29.3. Vacant land and/ or building in urban areas or urban agglomeration </h6>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <table class="table table-bordered table-hover-cells m-0 f-s">
                                                                                ...
                                                                                <tbody id="">
                                                                                    <tr class="p-1">
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_location_property_for_oc" name="spouce_location_property_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_location_property.spouce_location_property}}" placeholder="Enter Location of Property !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_location_property_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_location_property_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="p-1">
                                                                                        <td><b>2</b></td>
                                                                                        ...
                                                                                        <td class="p-1 f-gov-job d-none">
                                                                                            <input type="text" id="father_details_for_oc" name="father_details_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_details.father_details}}" placeholder="Enter Details of Property !"
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_details_for_oc" name="spouce_details_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_details.spouce_details}}" placeholder="Enter Details of Property !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_details_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_details_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="p-1">
                                                                                        <td><b>3</b></td>
                                                                                        ...
                                                                                        <td class="p-1 s-gov-job d-none">
                                                                                            <input type="text" id="spouce_use_to_which_for_oc" name="spouce_use_to_which_for_oc"
                                                                                                   maxlength="100" class="form-control" value="{{f_use_to_which.spouce_use_to_which}}" placeholder="Enter Detail !"
                                                                                                   onblur="checkValidation('obc-certificate', 'spouce_use_to_which_for_oc', spoucegovDetailValidationMessage);">
                                                                                            <span class="error-message error-message-obc-certificate-spouce_use_to_which_for_oc"></span>
                                                                                        </td>
                                                                                    </tr>
                                                        ...
                                                        <div class="card-body border-nic-blue pt-1 part_g_div" style="display: none;">
                                                            <div class="">
                                                                <div class="p-1 flex-fill">
                                                                              ...
                                                                              <div class="col-sm-12">
                                                                                  <div class="card collapsed-card">
                                                                                    <div class="card-header"  style="background-color: lavenderblush;">
                                                                                      <h3 class="card-title">30. PART G - Income/ Wealth<span class="color-nic-red">*</span></h3>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-sm-6">
                                                                            <label>30.1. Annual Family Income from all Sources. </label><br/>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-sm-6">
                                                                            <label>30.2. Weather Tax Payer(<span class="color-nic-red">*</span></label>
                                                                    ...
                                                                    <div class="row mb-2 tax_payer_item_container_for_obc_certificate" style="display: none;">
                                                                        <div class="col-12" id="tax_payer_copy_container_for_obc_certificate">
                                                                            <label>30.2.1. Copy of the last three years return be furnished (attahced First Page Only) <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-6">
                                                                        <label>30.3 Weather covered in wealth Tax Act. (<span class="color-nic-red">*</span></label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-6 wealth_tax_item_container_for_obc_certificate" style="display: none;">
                                                                        <label>30.3.1. If so Furnished Detailss <span class="color-nic-red">*</span></label>
                                                                        <div class="input-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-nic-blue pt-1">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            <label>31. For What Purpose is the Certificate of OBC Required. <span class="color-nic-red">*</span></label>
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label>32. Any other Remarks<span class="color-nic-red">*</span></label>
                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="applicant_photo_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Upload Applicant Photo (Latest) <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="applicant_photo_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Upload Applicant Photo (Latest) <span style="color: red;">*</span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="self_birth_certificate_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Original Birth Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="self_birth_certificate_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Original Birth Certificate <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="father_certificate_doc_container_for_obc_certificate">
                                    <label class="father_proof_item_container_for_obc_certificate" ><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Birth Certificate / Leaving Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label>

                                    <label class="father_death_proof_item_container_for_obc_certificate" style="display:none" ><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Death Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            ...
                            <!--  <div class="row mb-2 father_alive_for_death_certificate_container_for_obc_certificate" style="display: none;">
                                 <div class="col-12" id="father_death_certificate_container_for_obc_certificate">
                                     <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Death Certificate  <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                     <label class="f-w-n">Document Not Uploaded</label><br>
                                     <div class="error-message error-message-obc-certificate-father_death_certificate_for_obc_certificate"></div>
                                 </div>
                                 <div class="col-sm-12" id="father_death_certificate_name_container_for_obc_certificate" style="display: none;">
                                     <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Death Certificate  <span style="color: red;">* </span></label><br>
                                     <a target="_blank" id="father_death_certificate_download"><label id="father_death_certificate_name_image_for_obc_certificate" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_obc_certificate_{{VALUE_FOURTEEN}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                 </div>
                                 <div class="text-center color-nic-blue col-3 m-b-5px" id="spinner_template_{{VALUE_THREE}}" style="display: none;"><i class="fas fa-sync-alt fa-spin fa-1x"></i></div>
                             </div>  -->     
                            ...
                            <div class="row mb-2 if_father_alive_item_container_for_obc_certificate">
                                <!--  <div class="row mb-2"> -->
                                <!--                                <div class="col-12" id="father_election_card_container_for_obc_certificate">
                                                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                                                    <div class="error-message error-message-obc-certificate-father_election_card_for_obc_certificate"></div>
                                                                </div>
                                                                <div class="col-sm-12" id="father_election_card_name_container_for_obc_certificate" style="display: none;">
                                                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Election Card <span style="color: red;">* </span></label><br>
                                                                    <a target="_blank" id="father_election_card_download"><label id="father_election_card_name_image_for_obc_certificate" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_obc_certificate_{{VALUE_FOUR}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                                                </div>
                            ...
                            <div class="row mb-2 if_father_alive_item_container_for_obc_certificate">
                                <div class="col-12" id="father_aadhar_card_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Aadhaar Card <span style="color: red;"> (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="father_aadhar_card_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Aadhaar Card <span style="color: red;"> </span></label><br>
                            ...
                            <div class="row mb-2 if_mother_alive_item_container_for_obc_certificate">
                                <div class="col-12" id="mother_aadhar_card_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Mother Original Aadhaar Card <span style="color: red;"> (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="mother_aadhar_card_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Mother Original Aadhaar Card <span style="color: red;"> </span></label><br>
                            ...
                            <div class="row mb-2 if_father_alive_item_container_for_obc_certificate">  
                                <div class="col-12" id="father_election_card_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="father_election_card_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Father Original Election Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2 if_mother_alive_item_container_for_obc_certificate">  
                                <div class="col-12" id="mother_election_card_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Mother Original Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="mother_election_card_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant's Mother Original Election Card <span style="color: red;">* </span></label><br>
                            ...
                            <!--                            <div class="row mb-2">
                                                            <div class="col-12" id="election_card_doc_container_for_obc_certificate">
                                                                <label><span class="doc_no_for_obc_certificate"></span> Applicant Election Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                                                <label class="f-w-n">Document Not Uploaded</label><br>
                                                            ...
                                                            <div class="col-sm-12" id="election_card_doc_name_container_for_obc_certificate" style="display: none;">
                                                                <label><span class="doc_no_for_obc_certificate"></span> Applicant Election Card <span style="color: red;">* </span></label><br>
                                                                <a target="_blank" id="election_card_doc_download"><label id="election_card_doc_name_image_for_obc_certificate" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_obc_certificate_{{VALUE_NINE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="aadhar_card_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Original Aadhaar Card <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="aadhar_card_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Original Aadhaar Card <span style="color: red;">* </span></label><br>
                            ...
                            <div class="row mb-2">
                                <div class="col-12" id="community_certificate_doc_container_for_obc_certificate">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Community Certificate <span style="color: red;">* (Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                                    <label class="f-w-n">Document Not Uploaded</label><br>
                                ...
                                <div class="col-sm-12" id="community_certificate_doc_name_container_for_obc_certificate" style="display: none;">
                                    <label><span class="doc_no_for_obc_certificate"></span> Applicant Community Certificate <span style="color: red;">* </span></label><br>

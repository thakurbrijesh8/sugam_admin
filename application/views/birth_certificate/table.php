<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="BirthCertificate.listview.downloadExcelForBC();">
            <i class="fas fa-file-excel" style="margin-right: 2px;"></i>&nbsp; Download Excel</button>
    </div>
    <div class="card-body" id="birth_certificate_datatable_container">
        <div class="table-responsive">
            <table id="birth_certificate_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        <th></th>
                        <th>
                            <input type="text" id="app_no_for_birth_certificate_list"
                        ...
                        <th></th>
                        <th>
                            <select id="query_status_for_birth_certificate_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="status_for_birth_certificate_list" class="form-control"

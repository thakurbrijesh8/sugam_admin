...
<html>
    ...
    <body>
        ...
        if ($mtype == VALUE_ONE) {
            ?>
        <watermarktext content="Verification Copy" alpha="0.1" />
    <?php } else { ?>
    ...
    <div class="page-border">
        <table class="table-header">
            <tr>
                ...
                <?php
                if (isset($sign_data)) {
                    if ($sign_data['status_datetime'] == '' || $sign_data['status_datetime'] >= G20_LOGO_DT) {
                        ?>
                        <td style="text-align: right; vertical-align: middle;">
                            <!--<img src="images/g20-logo.png" style="width: 120px;">-->
                        </td>
                        <?php
                    }
                }

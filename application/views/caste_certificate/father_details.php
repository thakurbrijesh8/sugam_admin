<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="caste_certificate_father_form" name="caste_certificate_father_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="father_name_for_cc" name="father_name"
                                   maxlength="100" class="form-control" value="{{father_name}}" placeholder="Enter Father Name !" onblur="checkValidation('caste_certificate', 'father_name_for_cc', fatherNameValidationMessage);"
                                   >
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="father_house_no_for_cc" name="father_house_no" class="form-control" placeholder="Enter House No./Flat No. !" maxlength="100" value="{{father_house_no}}" onblur="checkValidation('caste_certificate', 'father_house_no_for_cc', houseNoValidationMessage);">
                            </div>
                            <span class="error-message error-message-caste-certificate-father_house_no_for_cc"></span>
                        </div>
                        <div class="form-group col-sm-6" style="margin-top:22px;">
                            ...
                            <div class="input-group">
                                <input type="text" id="father_house_name_for_cc" name="father_house_name" class="form-control" placeholder="Enter Building Name / House Name !" maxlength="100" value="{{father_house_name}}" onblur="checkValidation('caste_certificate', 'father_house_name_for_cc', houseNameValidationMessage);">
                            </div>
                            <span class="error-message error-message-caste-certificate-father_house_name_for_cc"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <input type="text" id="father_street_for_cc" name="father_street" class="form-control" placeholder="Enter Street !"
                                       maxlength="10" onblur="checkValidation('caste_certificate', 'father_street_for_cc', streetValidationMessage);" value="{{father_street}}">
                            </div>
                            <span class="error-message error-message-caste-certificate-father_street_for_cc"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <input type="text" id="father_village_dmc_ward_for_cc" name="father_village_dmc_ward" class="form-control" placeholder="Enter Village / DMC Ward !"
                                       maxlength="10" onblur="checkValidation('caste_certificate', 'father_village_dmc_ward_for_cc', villageNameValidationMessage);" value="{{father_village_dmc_ward}}">
                            </div>
                            <span class="error-message error-message-caste-certificate-father_village_dmc_ward_for_cc"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="father_city_for_cc" name="father_city"
                                        data-placeholder="City !"  onblur="checkValidation('caste_certificate', 'father_city_for_cc', selectCityValidationMessage);" >
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="father_nationality_for_cc" name="father_nationality" class="form-control" placeholder="Enter Father's Nationality!"
                                   maxlength="100" onblur="checkValidation('caste_certificate', 'father_nationality_for_cc', applicantNationalityValidationMessage);" value="{{father_nationality}}">
                                ...
                                <div class="input-group">
                                    <select id="father_native_place_state_for_cc" name="father_native_place_state" class="form-control select2"
                                            ...
                                            onchange="checkValidation('cc', 'father_native_place_state_for_cc', selectStateValidationMessage);
                                                CasteCertificate.listview.getDistrictData($(this), 'cc', 'father_native_place');">
                                    </select>
                                </div>
                                <span class="error-message error-message-caste-certificate-father_native_place_state_for_cc"></span>
                            </div>
                            <div class="form-group col-sm-4 col-md-4" style="margin-top:22px">
                                ...
                                <div class="input-group">
                                    <select id="father_native_place_district_for_cc" name="father_native_place_district" class="form-control select2"
                                            ...
                                            onchange="checkValidation('cc', 'father_native_place_district_for_cc', selectDistrictValidationMessage);
                                                CasteCertificate.listview.getVillageData($(this), 'cc', 'father_native_place');">
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <select id="father_occupation_for_cc" name="father_occupation" class="form-control select2" onchange="checkValidation('caste_certificate', 'father_occupation_for_cc', applicantOccupationValidationMessage);if(this.value == 12){$('.father_other_occupation_div_for_cc').show();}" data-placeholder="Select Occupation" style="width: 100%;">
                            </select>
                        ...
                        <div class="form-group col-sm-6 col-md-6">
                            <div class="father_other_occupation_div_for_cc" style="display: none;">
                                ...
                                <input type="text" id="father_other_occupation_for_cc" name="father_other_occupation"
                                       maxlength="100" class="form-control" value="{{father_other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('caste_certificate', 'father_other_occupation_for_cc', otherOccupationValidationMessage);"
                                       >
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="father_aadhaar_for_cc" name="father_aadhaar" class="form-control" placeholder="Enter Aadhar Number"
                                       maxlength="15" onkeyup="checkNumeric($(this));" onblur="aadharNumberValidation('caste_certificate', 'father_aadhaar_for_cc', invalidAadharNumberValidationMessage);" value="{{father_aadhaar}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="father_election_no_for_cc" name="father_election_no" class="form-control" placeholder="Enter Election Number"
                                       maxlength="15" onblur="aadharNumberValidation('caste_certificate', 'father_election_no_for_cc', electionNumberValidationMessage);" value="{{father_election_no}}">
                            </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_caste_certificate" class="btn btn-sm btn-success float-right" onclick="CasteCertificate.listview.submitFatherDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_father_details" class="btn btn-sm btn-success float-right" onclick="CasteCertificate.listview.editOrViewCasteCertificate($('#previous_btn_for_caste_certificate'), '{{caste_certificate_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>

            ...
            <form role="form" id="caste_certificate_form" name="caste_certificate_form" onsubmit="return false;">
               ...
               <div class="row">
                   ...
                   <!------------------------------------------------->
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_caste_certificate" class="btn btn-sm btn-success" onclick="CasteCertificate.listview.askForSubmitCasteCertificate({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

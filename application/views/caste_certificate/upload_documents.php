<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="domicile_upload_document_form" name="domicile_upload_document_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                            <button type="button" id="previous_btn_for_spouse_details" class="btn btn-sm btn-success pull-right" onclick="Domicile.listview.editOrViewDomicile($('#previous_btn_for_domicile'), '{{domicile_certificate_id}}', true, {{VALUE_THREE}});" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                            <!-- <button type="button" id="draft_btn_for_domicile" class="btn btn-sm btn-success pull-right" onclick="Domicile.listview.submitSpouseDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                            <button type="button" class="btn btn-sm btn-danger" onclick="Domicile.listview.loadDomicileData();">Cancel</button> -->
                            <!-- <button type="button" id="draft_btn_for_domicile" class="btn btn-sm btn-nic-blue" onclick="Domicile.listview.submitUploadDocuments({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button> -->

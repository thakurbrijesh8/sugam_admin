...
<html>
    <head>
        ...
        <?php
        $barcode_number = generate_barcode_number(VALUE_TWENTYNINE, $payment_data['landtax_agriculture_payment_id']);
    ...
    <body>
        <div class="outer-box">
            ...
            <div class="l-s l-h" style="text-align:justify; line-height: 25px; margin-top: 20px;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Received the sum of <span class="b-b-1px f-w-b"><?php echo '₹' . $payment_data['total_amount'] . '/- (' . (convert_to_indian_currency($payment_data['total_amount'])) . ')'; ?></span>
                on account of <span class="b-b-1px f-w-b">Agriculture</span> Land Revenue 
                for the year <span class="b-b-1px f-w-b">2021-22</span>.
            </div>
            <table class="table-header table-border f-s-12px" style="margin-top: 28px;">
                <tr>
                    ...
                    <td class="t-a-c f-w-b" style="width: 100px;">Occupant Name</td>
                ...
                foreach ($payment_ld_data as $index => $pld) {
                    ...
                    <tr>
                        ...
                        <td class="f-aum t-a-c"><?php echo $payment_data['occupant_name']; ?></td>
                        <td class="t-a-r"><?php echo $pld['ld_tax_payment']; ?>/-</td>
                    </tr>
                <?php } ?>
                <tr>
                    <td class="t-a-r f-w-b" colspan="3" style="padding-right: 5px;">Grand Total</td>

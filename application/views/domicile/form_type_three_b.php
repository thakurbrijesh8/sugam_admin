        ...
        <div class="card">
            ...
            <form role="form" id="domicile_form" name="domicile_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" id="constitution_artical" name="constitution_artical" value="6">
                    To,<br>
                    The Mamlatdar,
                    <div class="card">
                        ...
                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                            <div class="row">
                                <div class="col-12 f-w-b">
                                    17. Applicant Education Details.
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="father_occupation_for_dc" name="father_occupation" class="form-control select2" onchange="checkValidation('domicile', 'father_occupation_for_dc', applicantOccupationValidationMessage); if (this.value == 12) {
                                                                ...
                                                                $('.father_other_occupation_div_for_dc').hide();
                                                            }" data-placeholder="Select Occupation" style="width: 100%;">
                                                    </select>
                    ...
                    <div class="card">
                        <div class="card-header pt-1 pb-1 bg-nic-blue">
                            <div class="row">
                                <div class="col-12 f-w-b">
                                    19. Residential details of last 10 year in the U.T. Of Daman & Diu.
                                </div>
                            </div>
                        </div>
                        <div class="card-body border-nic-blue">
                            ...
                            <div class="row">
                                <div  class="leaving_certificate_item_container_for_domicile_certificate" > 
                                    <div class="col-12 m-b-5px" id="leaving_certi_container_for_domicile">
                                        <label>3. Applicant Original Leaving Certificate / Bonified Certificate / Marksheets <span style="color: red;">* <br>Since K.G. to till date education bonofied certificate or leaving or marksheet must be uploaded in file.<br/>(Maximum File Size: 10MB) &nbsp; (Upload PDF Only & Multiple PDF selection allow)</span></label><br>
                                        <label class="f-w-n">Document Not Uploaded</label><br>
                                    ...
                                    <div class="form-group col-sm-12" id="leaving_certi_name_container_for_domicile" style="display: none;">
                                        <label>3. Applicant Original Leaving Certificate / Bonified Certificate / Marksheets<span style="color: red;">* </span></label><br>

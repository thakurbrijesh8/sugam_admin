<div class="card-header">
    <h3 class="card-title f-w-b" style="float: none; text-align: center;">
        {{title}} Application for issue of Certified Copy
    </h3>
</div>
        ...
        <table class="table table-bordered table-padding">
            <thead>
                <tr>
                    ...
                    <th class="f-w-b text-center v-a-m bg-beige" style="width: 95px;">Document Required</th>
            ...
            <tbody id="fld_container_for_certi_c_view"></tbody>
            <tfoot>
                <tr>
                    <td class="f-w-b text-right text-success v-a-m bg-beige" colspan="8">Rupees To Be Paid : </td>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Copies : <span id="total_copies_for_certi_c_view"></span></th>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Pages : <span id="total_pages_for_certi_c_view"></span></th>
                    <th class="f-w-b text-right text-success v-a-m bg-beige">Rs. : <span id="total_amount_for_certi_c_view"></span></th>
                </tr>
            </tfoot>
        </table>
    </div>
            ...
            <tr>
                ...
                <td style="width: 180px; border-top: none;">
                    <img style="border: 2px solid blue; width: 160px; height: 180px;"
                         src="{{CERTIFIED_COPY_DOC_PATH}}{{applicant_photo}}">
                </td>
                {{/if}}
                <td style="border-top: none; vertical-align: top !important;">
                    <div>
                        {{#if show_id_proof}}
                        <a target="_blank" href="{{CERTIFIED_COPY_DOC_PATH}}{{id_proof}}">
                        ...
                        <a target="_blank" href="{{CERTIFIED_COPY_DOC_PATH}}{{other_document}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
...
<div class="card-footer text-right">
    {{#if show_print_btn}}
    <button type="button" class="btn btn-sm btn-danger" onclick="window.print();" id="pa_btn_for_certi_c_view">

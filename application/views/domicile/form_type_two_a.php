                        ...
                        <div class="card-body border-nic-blue pt-1">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="occupation_for_dc" name="occupation" class="form-control select2" onchange="checkValidation('domicile', 'occupation_for_dc', applicantOccupationValidationMessage); if (this.value == 12) {
                                                ...
                                                $('.other_occupation_div_for_dc').hide();
                            ...
                            <!-- <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="applicant_education_for_dc" name="applicant_education" class="form-control select2" onchange="checkValidation('domicile', 'applicant_education_for_dc', applicantEducationValidationMessage);
                                            if (this.value == 12) {
                                                $('.other_applicant_education_div_for_dc').show(); } else {
                                ...
                                <div class="card-body p-0 father_info_div border-nic-blue" style="display: none;" >
                                    <div class="p-1 flex-fill" style="overflow: hidden">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-3 col-md-3" style="margin-top:22px">
                                                <label>3.4 Pincode <span class="color-nic-red">*</span></label>        <input type="text" id="father_native_pincode_for_dc" name="father_native_pincode" class="form-control" placeholder="Enter Pincode !" 
                                        ...
                                        <div class="is_father_alive_container_for_dc">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="father_occupation_for_dc" name="father_occupation" class="form-control select2" onchange="checkValidation('domicile', 'father_occupation_for_dc', applicantOccupationValidationMessage);
                                                            if (this.value == 12) {
                                        ...
                                        <div class="is_mother_alive_container_for_dc">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="mother_occupation_for_dc" name="mother_occupation" class="form-control select2" onchange="checkValidation('domicile', 'mother_occupation_for_dc', applicantOccupationValidationMessage); if (this.value == 12) {
                                                                $('.mother_other_occupation_div_for_dc').show(); } else {
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="spouse_occupation_for_dc" name="spouse_occupation" class="form-control select2" onchange="checkValidation('domicile', 'spouse_occupation_for_dc', applicantOccupationValidationMessage); if (this.value == 12) {
                                                                $('.spouse_other_occupation_div_for_dc').show(); } else {
                                                                $('.spouse_other_occupation_div_for_dc').hide(); }" data-placeholder="Select Occupation" style="width: 100%;">
                                                    </select>
                            ...
                            <div class="row">
                                <div  class="other_document_item_container_for_domicile_certificate" > 
                                    <div class="col-12 m-b-5px" id="other_document_container_for_domicile">
                                        <label>18. Other Document<span style="color: red;"> <br>(Maximum File Size: 5MB)(Upload pdf Only & Multiple PDF selection allow)</span></label><br>
                                        <label class="f-w-n">Document Not Uploaded</label><br>
                                    ...
                                    <div class="form-group col-sm-12" id="other_document_name_container_for_domicile" style="display: none;">
                                        <label>18. Other Document <span style="color: red;"> </span></label><br>

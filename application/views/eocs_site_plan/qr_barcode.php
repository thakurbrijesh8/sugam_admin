...
$header_array['district'] = $espld_data['district'] == VALUE_ONE ? 'Daman' : ($espld_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Diu');
...
<div>
    ...
    <h3><b>Mobile Number : <?php echo $espld_data['mobile_number']; ?></b></h3>
</div>
...
<?php $this->load->view('certificate/copy_footer', array('barcode_number' => $barcode_number, 'url' => $url, 'mobile_number' => $espld_data['mobile_number'])); ?>
<div class="card-header">
    <h3 class="card-title" style="float: none; text-align: center;">Reject RTI Form</h3>
</div>
<form role="form" id="reject_rti_form" name="reject_rti_form" onsubmit="return false;" style="font-size: 14px;">
    <input type="hidden" id="rti_id_for_rti_reject" name="rti_id_for_rti_reject" value="{{rti_id}}">
    <div class="card-body p-b-0px text-left">
        <div class="row">
            <div class="col-sm-12 text-center">
                <span class="error-message error-message-rti-reject f-w-b" style="border-bottom: 2px solid red;"></span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <textarea id="remarks_for_rti_reject" name="remarks_for_rti_reject" class="form-control"
                          onblur="checkValidation('rti-reject', 'remarks_for_rti_reject', remarksValidationMessage);"
                          placeholder="Remarks !" maxlength="1500" rows="3"></textarea>
                <span class="error-message error-message-rti-reject-remarks_for_rti_reject"></span>
            </div>
        </div>
        <hr class="m-b-1rem">
        <div class="form-group">
            <button type="button" id="submit_btn_for_rti_reject" class="btn btn-sm btn-danger" onclick="Rti.listview.rejectApplication();"

   ...
   <div class="table-responsive">
        <table class="table table-bordered table-padding bg-beige">
           <tr>
            ...
            <tr>
                <td class="f-w-b">Death Person Name</td>
                <td>{{death_person_name}}</td>
            </tr>
            <tr>
                <td class="f-w-b">Date of Death</td>
                <td>{{death_person_dod_text}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="f-w-b">Husband/Wife Name</td>
                <td>{{husband_wife_name}}</td>
            </tr>
            <tr>
                <td class="f-w-b">Communication Address</td>
                <td>{{dp_communication_address}}</td>
            </tr>
            <tr>
                <td class="f-w-b">Permanent Address</td>
                <td>{{dp_permanent_address}}</td>
            </tr>
            <tr>
            ...
            <table class="table mb-0">
                ...
                <td style="width: 180px;">
                    <img style="border: 2px solid blue; width: 160px; height: 180px;"
                         src="{{DEATH_CERTIFICATE_DOC_PATH}}/{{applicant_photo_doc}}">
                </td>
                {{/if}}
                <td>
                    <div>
                        {{#if show_birth_certi_doc}}
                        <a target="_blank" href="{{DEATH_CERTIFICATE_DOC_PATH}}{{birth_certi_doc}}">
                        ...
                        <a target="_blank" href="{{DEATH_CERTIFICATE_DOC_PATH}}{{aadhar_card_doc}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                                <i class="fas fa-download"></i> &nbsp; Aadhar Card
                            </label>
                        </a>
                        {{/if}}
                        {{#if show_old_death_certi_doc}}
                        <a target="_blank" href="{{DEATH_CERTIFICATE_DOC_PATH}}{{old_death_certi_doc}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                                <i class="fas fa-download"></i> &nbsp; Old Death Certificate
                            </label>
                        </a>
                        {{/if}}

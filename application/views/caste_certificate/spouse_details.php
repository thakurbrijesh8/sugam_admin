<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="caste_certificate_spouse_form" name="caste_certificate_spouse_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="spouse_name_for_cc" name="spouse_name"
                                   maxlength="100" class="form-control" value="{{spouse_name}}" placeholder="Enter Spouse Name !" onblur="checkValidation('caste_certificate', 'spouse_name_for_cc', spouseNameValidationMessage);"
                                   >
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="spouse_house_no_for_cc" name="spouse_house_no" class="form-control" placeholder="Enter House No./Flat No. !" maxlength="100" value="{{spouse_house_no}}" onblur="checkValidation('caste_certificate', 'spouse_house_no_for_cc', houseNoValidationMessage);">
                            </div>
                            <span class="error-message error-message-caste-certificate-spouse_house_no_for_cc"></span>
                        </div>
                        <div class="form-group col-sm-6" style="margin-top:22px;">
                            ...
                            <div class="input-group">
                                <input type="text" id="spouse_house_name_for_cc" name="spouse_house_name" class="form-control" placeholder="Enter Building Name / House Name !" maxlength="100" value="{{spouse_house_name}}" onblur="checkValidation('caste_certificate', 'spouse_house_name_for_cc', houseNameValidationMessage);">
                            </div>
                            <span class="error-message error-message-caste-certificate-spouse_house_name_for_cc"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <input type="text" id="spouse_street_for_cc" name="spouse_street" class="form-control" placeholder="Enter Street !"
                                       maxlength="10" onblur="checkValidation('caste_certificate', 'spouse_street_for_cc', streetValidationMessage);" value="{{spouse_street}}">
                            </div>
                            <span class="error-message error-message-caste-certificate-spouse_street_for_cc"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <input type="text" id="spouse_village_dmc_ward_for_cc" name="spouse_village_dmc_ward" class="form-control" placeholder="Enter Village / DMC Ward !"
                                       maxlength="10" onblur="checkValidation('caste_certificate', 'spouse_village_dmc_ward_for_cc', villageNameValidationMessage);" value="{{spouse_village_dmc_ward}}">
                            </div>
                            <span class="error-message error-message-caste-certificate-spouse_village_dmc_ward_for_cc"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="spouse_city_for_cc" name="spouse_city"
                                        data-placeholder="City !"  onblur="checkValidation('caste_certificate', 'spouse_city_for_cc', selectCityValidationMessage);" >
                                    <option value="">Select City</option>
                                    <option value="1">Nani Daman</option>
                                    <option value="2">Moti Daman</option>
                                </select>
                            </div>
                            <span class="error-message error-message-caste-certificate-spouse_city_for_cc"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="spouse_nationality_for_cc" name="spouse_nationality" class="form-control" placeholder="Enter Spouse's Nationality!"
                                   maxlength="100" onblur="checkValidation('caste_certificate', 'spouse_nationality_for_cc', applicantNationalityValidationMessage);" value="{{spouse_nationality}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <select id="spouse_occupation_for_cc" name="spouse_occupation" class="form-control select2" onchange="checkValidation('caste_certificate', 'spouse_occupation_for_cc', applicantOccupationValidationMessage);if(this.value == 12){$('.spouse_other_occupation_div_for_cc').show();}" data-placeholder="Select Occupation" style="width: 100%;">
                            </select>
                        ...
                        <div class="form-group col-sm-6 col-md-6">
                            <div class="spouse_other_occupation_div_for_cc" style="display: none;">
                                ...
                                <input type="text" id="spouse_other_occupation_for_cc" name="spouse_other_occupation"
                                       maxlength="100" class="form-control" value="{{spouse_other_occupation}}" placeholder="Enter Other Occupation !" onchange="checkValidation('caste_certificate', 'spouse_other_occupation_for_cc', otherOccupationValidationMessage);"
                                       >
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="spouse_aadhaar_for_cc" name="spouse_aadhaar" class="form-control" placeholder="Enter Aadhar Number"
                                       maxlength="15" onkeyup="checkNumeric($(this));" onblur="aadharNumberValidation('caste_certificate', 'spouse_aadhaar_for_cc', invalidAadharNumberValidationMessage);" value="{{spouse_aadhaar}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="spouse_election_no_for_cc" name="spouse_election_no" class="form-control" placeholder="Enter Election Number"
                                       maxlength="15" onblur="aadharNumberValidation('caste_certificate', 'spouse_election_no_for_cc', electionNumberValidationMessage);" value="{{spouse_election_no}}">
                            </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_caste_certificate" class="btn btn-sm btn-success float-right" onclick="CasteCertificate.listview.submitSpouseDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_spouse_details" class="btn btn-sm btn-success float-right" onclick="CasteCertificate.listview.editOrViewCasteCertificate($('#previous_btn_for_caste_certificate'), '{{caste_certificate_id}}', true, {{VALUE_TWO}});" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>

...
<div>
    ...
    <div class="timeline-item">
        <span class="time text-dark f-w-b"><i class="fas fa-clock"></i> Query Response By & Date Time : <span class="color-nic-red">{{query_by_name}} ( {{query_by_mobile_number}} ) ( {{datetime_text}} )</span></span>

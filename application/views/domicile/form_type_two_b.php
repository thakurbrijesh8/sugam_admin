        ...
        <div class="card">
            ...
            <form role="form" id="domicile_form" name="domicile_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" id="constitution_artical" name="constitution_artical" value="3">
                    To,<br>
                    The Mamlatdar,
                    <div class="card">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="mother_occupation_for_dc" name="mother_occupation" class="form-control select2" onchange="checkValidation('domicile', 'mother_occupation_for_dc', applicantOccupationValidationMessage);
                                                            if (this.value == 12) {
                                                                ...
                                                                $('.mother_other_occupation_div_for_dc').hide();
                                                            }" data-placeholder="Select Occupation" style="width: 100%;">
                                                    </select>
                                        ...
                                        <div class="is_spouse_alive_container_for_dc">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <select id="spouse_occupation_for_dc" name="spouse_occupation" class="form-control select2" onchange="checkValidation('domicile', 'spouse_occupation_for_dc', applicantOccupationValidationMessage);
                                                            if (this.value == 12) {

                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <select id="user_type_for_users" name="user_type_for_users" class="form-control select2"
                                    ...
                                    onchange="checkValidation('users', 'user_type_for_users', selectUserTypeValidationMessage); Users.listview.villageShowHideChangeEvent($(this));"
                                    style="width: 100%;">
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <select id="district_for_users" name="district_for_users" class="form-control select2"
                                    onchange="Users.listview.villageShowHideChangeEvent($(this));"
                                    data-placeholder="Select District" style="width: 100%;">
                            </select>
                            <span class="error-message error-message-users-district_for_users"></span>
                        </div>
                    </div>
                    <div class="row" id="villages_container_for_users" style="display: none">
                        <div class="form-group col-sm-12">
                            <label>Villages</label>
                            <div id="assign_villages_container_for_users"></div>
                            <span class="error-message error-message-users-assign_villages_for_users"></span>
                        </div>
                    </div>
                    <div class="form-group">

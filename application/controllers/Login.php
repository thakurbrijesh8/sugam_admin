...
class Login extends CI_Controller {
    ...
    function check_login() {
        try {
            ...
            $session_data = array();
            $session_data['temp_id_for_sugam_admin'] = $new_user_data['sa_user_id'];
            $session_data['name'] = ucwords($new_user_data['name']);
            $session_data['temp_type_for_sugam_admin'] = $new_user_data['user_type'];
            $session_data['temp_type_name_for_sugam_admin'] = $new_user_data['user_type_name'];
            $session_data['temp_district_for_sugam_admin'] = $new_user_data['district'];
            $session_data['temp_av_for_sugam_admin'] = $new_user_data['assign_villages'];
    ...
    function _destroy_session() {
        $temp_user_id = get_from_session('temp_id_for_sugam_admin');
